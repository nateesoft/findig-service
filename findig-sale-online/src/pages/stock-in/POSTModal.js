                    ...
                    return (
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                        <div className="text-center p-4 rounded-lg border-2 border-blue-200 dark:border-blue-700">
                          ...
                          <div className={`text-sm ${getThemeClasses('textSecondary', currentTheme)}`}>รายการโอนสินค้าเข้า</div>
                        </div>
                        ...
                        <div className="text-center p-4 rounded-lg border-2 border-purple-200 dark:border-purple-700">
                          <div className="text-2xl font-bold text-purple-600">{tempSales.length > 0 ? tempSales[0].branch_stock_in_code || 'หลายสาขา' : '-'}</div>
