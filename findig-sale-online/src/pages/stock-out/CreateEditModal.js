...
const CreateEditModal = ({
  ...
  const handleSubmitClick = () => {
    ...
    if (!saleHeader.branchStockOutCode) {
      missingFields.push('รหัสสาขาที่โอนออก');
    }
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                >
                  {modalMode === "edit"
                    ? "แก้ไขข้อมูลการโอนสินค้าออก"
                    : "เพิ่มข้อมูลการโอนสินค้าออก"}
                </h3>
                <p
                ...
                >
                  {modalMode === "edit"
                    ? "แก้ไขข้อมูลการโอนสินค้าออกที่มีอยู่"
                    : "กรอกข้อมูลการโอนสินค้าออกใหม่ (รองรับหลายรายการ)"}
                </p>
              </div>
            </div>
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setSaleHeader({ ...saleHeader, billNo: e.target.value, branchStockOutCode: branchCode })
                  }
