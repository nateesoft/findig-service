      ...
      <div className="p-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
          ...
          <div>
            ...
            <DatePicker
              selected={searchCriteria.S_Date_Start ? parseDate(searchCriteria.S_Date_Start) : null}
              onChange={date =>
                setSearchCriteria({
                  ...searchCriteria,
                  S_Date_Start: date ? formatDate(date) : ""
                })
              }
          ...
          <div>
            ...
            <DatePicker
              selected={searchCriteria.S_Date_End ? parseDate(searchCriteria.S_Date_End) : null}
              onChange={date =>
                setSearchCriteria({
                  ...searchCriteria,
                  S_Date_End: date ? formatDate(date) : ""
                })
              }
              dateFormat="dd/MM/yyyy"
              className={`w-full px-3 py-2 border rounded-lg ${getThemeClasses("input", currentTheme)}`}
