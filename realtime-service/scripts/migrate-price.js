/**
 * Migration: add price column to draft_sale_details
 *
 * Usage:
 *   npm run migrate:price              (DEVELOPMENT)
 *   npm run migrate:price PRODUCTION
 *   npm run migrate:price TEST
 *   npm run migrate:price ALL
 */
...
const MIGRATIONS = [
  {
    ...
    column: 'price',
    sql: `ALTER TABLE draft_sale_details ADD COLUMN price decimal(10,2) NOT NULL DEFAULT 0.00`
  }
];
